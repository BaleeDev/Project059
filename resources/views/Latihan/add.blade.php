        ...
        <div class="col-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('nama_mk')
                  is_invalid
              @enderror" id="nama_mk" name="nama_mk" value="{{old('nama_mk')}}" placeholder="Inputkan Nama Matakuliah">
              @error('nama_mk')
        ...
        <div class="col-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('dosen')
                  is-invalid
              @enderror" id="dosen" name="dosen" value="{{old('dosen')}}" placeholder="Inputkan Nama Dosen">
              @error('dosen')
        ...
        <div class="col-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('jumlah_soal')
                  is-invalid
              @enderror" id="jumlah_soal" name="jumlah_soal" value="{{old('jumlah_soal')}}" placeholder="Inputkan Jumlah Soal"> @error('jumlah_soal')
                  <div class="invalid-feedback">
                      {{$message}}
                  </div>
              @enderror
